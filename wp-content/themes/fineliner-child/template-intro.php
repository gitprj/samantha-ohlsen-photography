<?php
    ...
    $title = balanceTags( wp_kses( $title, $allowed_html ), true );
    $body = balanceTags( $body, true );
...
<?php if ( is_singular( 'uxbarn_team' ) || ( $is_displayed == 'false' && is_single() ) ||
			( $is_displayed == 'false' && is_page() && ! uxbarn_is_frontpage_child() ) ) : ?>
	<hr class="layout-divider content-width" />
<?php endif; ?>

<?php if ( class_exists( 'Woocommerce' ) && $is_displayed == 'false' && is_shop() ) : ?>
	<hr class="layout-divider content-width" />
<?php endif; ?>

<?php if ( $is_displayed == 'false' && is_home() ) : ?>
	<hr class="layout-divider content-width" />
<?php endif; ?>
